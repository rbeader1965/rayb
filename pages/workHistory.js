...
<table className="w-auto p-2 md:p-1 text-xs text-center text-blue-500 dark:text-blue-400">
  ...
  <tbody>
      {data1.map((image) => (
    <tr key={image.id} className="text-xs md:text-xl border-b dark:bg-amber-900 dark:border-zinc-700 odd:bg-white even:bg-amber-50 odd:dark:bg-zinc-900 even:dark:bg-zinc-700">
