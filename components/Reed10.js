...
const Reed10 = () => {
  return (
    <div className='bg-slate-500 flex p-12 justify-center gap-2'>
    <h2 className='text-2xl md:text-3xl text-gray-700 font-semibold'>Titan</h2>
    <button className='bg-gray-400 mt-2 mr-3 rounded-full ring-offset-2 ring-2 text-xs p-1 hover:bg-gray-800 hover:text-white'>
