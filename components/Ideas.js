...
const Ideas = ({data1}) => {
  return (
    <div>
        <table className="md:max-w-full max-w-2xl m-auto text-sm text-center text-gray-500 dark:text-gray-400">
  ...
  <tbody>
    ...
    <tr key={image.id} className="border-b dark:bg-gray-900 dark:border-gray-700 odd:bg-white even:bg-gray-50 odd:dark:bg-gray-900 even:dark:bg-gray-700">
        <td  className="px-6 py-4">{format(new Date(image.mates),'MM/dd/yyyy')}</td>
