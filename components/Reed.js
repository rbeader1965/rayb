...
const Reed = () => {
  return (
    <div className='bg-green-500 grid grid-cols-1 md:flex p-2  md:p-12 justify-center gap-2'>
    <h2 className='mt-2 text-2xl text-gray-700 font-roboto font-semibold'>Marlin</h2>
<button className='bg-gray-400 mt-3 mr-2 rounded-full ring-offset-2 ring-2 text-xs p-1 hover:bg-gray-800 hover:text-white'>
...
<button className='bg-gray-400 mt-3 mr-1 rounded-full ring-offset-2 ring-2 text-xs p-1 hover:bg-gray-800 hover:text-white'>
